...
export const getAnalytics = async (
  ...
  try {
    ...
    const aggregated = {
      totalImpressions: analytics?.reduce((sum, a) => sum + a.impressions_count, 0) || 0,
      totalEngagement: analytics?.reduce((sum, a) => sum + a.likes_count + a.comments_count + a.shares_count, 0) || 0,
      ...
      byPlatform: analytics?.reduce((acc: any, a) => {
        ...
        acc[a.platform].engagement += a.likes_count + a.comments_count + a.shares_count;
